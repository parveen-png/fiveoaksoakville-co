...
export const copy = {
  ...
  renderingQualifier: "Artist's concept. Homes as built may differ.",
  factsExplanation:
  ...
  pricingFormSupport:
    "Get notified when official pricing is published.",
  formTrust: [
...
export const seo = {
  ...
  ogTitle: "Five Oaks Oakville | Independent Coming-Soon Brief",
  keywords: [
    "Five Oaks Oakville",
    "Five Oaks by Caivan",
...
export const images = {
  hero: {
    ...
    alt: "Aerial of a creek valley and parkland in Oakville. Neighbourhood illustration only; not a confirmed Five Oaks site pin.",
    width: 1024,
    height: 682,
  },
  logo: {
  ...
  communityAerial: {
    ...
    alt: "Aerial of an Oakville-area neighbourhood and open space. Neighbourhood illustration only; not a confirmed Five Oaks site pin.",
    width: 5305,
    height: 2985,
  },
  pondPathway: {
    src: "/images/pond-pathway-aerial.jpg",
    alt: "Aerial of a pond and pathway in an Oakville-area setting. Neighbourhood illustration only; not a confirmed Five Oaks site pin.",
    width: 5000,
    height: 3300,
  },
  creekAerial: {
    src: "/images/community-sixteen-mile-creek.jpg",
    alt: "Creek valley and surrounding trees in Oakville. Neighbourhood illustration only; not a confirmed Five Oaks site pin.",
    width: 1024,
    height: 544,
  },
  collection24: {
    src: "/images/24-collection-elevation-b.jpg",
    alt: "Five Oaks 24′ Collection Elevation B, artist's concept. Not a floor plan.",
    width: 5000,
    height: 2674,
  },
  starling40: {
    src: "/images/40-starling-corner-elevation-b.jpg",
    alt: "Five Oaks The Starling corner Elevation B, artist's concept. Not a floor plan.",
    width: 5000,
    height: 2886,
  },
  merlin42: {
    src: "/images/42-merlin-elevation-a.jpg",
    alt: "Five Oaks The Merlin Elevation A, artist's concept. Not a floor plan.",
    width: 5000,
    height: 2886,
  },
  sandhill50: {
    src: "/images/50-sandhill-elevation-b.jpg",
    alt: "Five Oaks The Sandhill Elevation B, artist's concept. Not a floor plan.",
    width: 5000,
    height: 2885,
  },
  advantageTowns: {
    src: "/images/advantage-townhomes-elevation-b.jpg",
    alt: "Five Oaks Advantage Townhomes Elevation B, artist's concept. Not a floor plan.",
    width: 5000,
    height: 2673,
  },
  b2b: {
    src: "/images/b2b-elevation-a.jpg",
    alt: "Five Oaks back-to-back townhomes Elevation A, artist's concept. Not a floor plan.",
    width: 5000,
    height: 2780,
  },
  breakfast: {
    src: "/images/breakfast.jpg",
    alt: "Five Oaks breakfast area interior, artist's concept. Not a floor plan.",
    width: 4500,
    height: 5000,
  },
  greatRoom: {
    src: "/images/great-room.jpg",
    alt: "Five Oaks great room interior, artist's concept. Not a floor plan.",
    width: 5000,
    height: 3250,
  },
  kitchenSingles: {
    src: "/images/kitchen-singles.jpg",
    alt: "Five Oaks detached-home kitchen interior, artist's concept. Not a floor plan.",
    width: 5000,
    height: 3125,
  },
  kitchenTowns: {
    src: "/images/kitchen-towns.jpg",
    alt: "Five Oaks townhome kitchen interior, artist's concept. Not a floor plan.",
    width: 4500,
    height: 5000,
  },
  lakeshore: {
