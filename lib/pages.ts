...
export const locationPage: PageContent = {
  ...
  description:
    "Five Oaks is in Oakville, Ontario. Exact address TBA as of August 24, 2026. Register for verified updates. No commute or pin claims.",
...
export const homesPage: PageContent = {
  ...
  description:
    "Five Oaks Oakville plans single-detached homes and townhomes. Models, lots and sizes TBA as of August 24, 2026. Register for updates.",
...
export const pricingPage: PageContent = {
  path: "/pricing",
  title: "Five Oaks Prices Oakville | Official List Not Published",
  description:
    "Official Five Oaks prices are not published as of August 24, 2026. No starting price, list or deposit schedule. Register for verified updates.",
...
export const floorPlansPage: PageContent = {
  ...
  description:
    "Five Oaks floor plans are not published as of August 24, 2026. Elevation renderings are artist's concepts, not layouts. Register for plan updates.",
  h1: "Five Oaks floor plans",
  answer:
    "Are Five Oaks floor plans available? Not yet. Interior layouts, bedroom counts and square footage have not been published. Artist's elevation concepts from current project materials appear on this page so you can see named collections. They are not floor plans, and homes as built may differ. This independent site does not invent unofficial layouts. Register when Caivan Communities releases official plans for the Oakville community.",
  factExcerpt:
...
export const faqsPage: PageContent = {
  ...
  description:
    "Five Oaks Oakville FAQs: location, homes, prices, floor plans, deposits, incentives, launch timing. Honest TBA dated August 24, 2026. Register.",
