...
export function LeadForm({
  ...
  const helper = supportText ?? (compact ? undefined : copy.formSupport);
  const title = heading ?? (compact ? project.primaryCta : "Get Five Oaks project updates");
...
function inputClass(invalid: boolean) {
  return `min-h-11 w-full rounded-none border bg-paper-elevated px-3 text-base text-ink outline-none transition-colors focus-visible:ring-2 focus-visible:ring-bronze ${
